...
interface LearningPageProps {
  ...
  /** Adaptive Branch only: current phase in the flow. */
...
export const LearningPage: React.FC<LearningPageProps> = ({
  ...
  const resourceLabel = (ft: string) => {
    ...
    if (ft === 'video') return 'Watch Video';

    if (ft === 'pdf')   return 'Open PDF';

    return 'Go to Resource';
  ...
  return (
    ...
    <div className="flex h-screen bg-[#0f172a]">
      ...
      <main className="flex-1 ml-72 overflow-y-auto relative">
        ...
        {isMasteryGate && !masteryAchieved && (
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-sm font-bold text-purple-300 mb-0.5">Mastery Gate Active</div>

              <div className="text-xs text-slate-400 leading-relaxed">

                Answer <span className="text-purple-300 font-bold">{masteryThreshold} questions in a row</span> correctlyu

                correctly to unlock this section. Current streak: <span className="text-purple-300 font-bold">{consecutiveCorrect}/{masteryThreshold}</span>
        ...
        {isMasteryGate && masteryAchieved && (
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm font-bold text-emerald-300">Mastery Gate Passed! 🎉</div>

              <div className="text-xs text-slate-400">You answered {masteryThreshold} questions in a row correctly. You can now move to the next section.</div>
        ...
        {/* Spaced Retrieval notification banner */}
        ...
        {flowPattern === 'spaced_retrieval' && (
          ...
          >
            ...
            <div className="text-xs text-slate-400">
              ...
              <span className="text-amber-300 font-bold">Spaced Retrieval</span> active. Spaced reviews have been scheduled for days 1, 3, and 7.
        ...
        {/* Adaptive Branch notification banner */}
        ...
        {flowPattern === 'adaptive_branch' && (
          ...
          >
            ...
            <div className="text-xs text-slate-400">
              ...
              <span className="text-emerald-300 font-bold">Adaptive Branch</span> active. Initial questions will assess your level and adapt the content accordingly.
        ...
        {isAdaptive && adaptivePhase === 'question_first' && (
          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-slate-400">Solve a question first — content will be tailored to your level.</div>
        ...
        {isAdaptive && adaptivePhase === 'intro_lesson' && (
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm font-bold text-red-300 mb-0.5">Let's Learn This From Scratch</div>

              <div className="text-xs text-slate-400">You couldn't solve the question yet. Let's cover the material from the beginning, then you'll try again.</div>
        ...
        {isAdaptive && adaptivePhase === 'advanced_lesson' && (
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm font-bold text-emerald-300 mb-0.5">Great! Moving to Advanced Content</div>

              <div className="text-xs text-slate-400">You answered correctly! You can read the advanced content and then move to the next topic.</div>
        ...
        {/* Confirmation banner — verify understanding after the lesson */}
        ...
        {isAdaptive && adaptivePhase === 'confirmation' && (
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm font-bold text-indigo-300 mb-0.5">Test What You've Learned</div>

              <div className="text-xs text-slate-400">You finished the lesson! Now solve the same question again to prove what you've learned.</div>
        ...
        {/* Course resources — rendered only when available */}
            ...
            >
              ...
              <div className="bg-[#1a2235] border border-slate-800 rounded-2xl p-5">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-xs font-bold text-slate-300 uppercase tracking-widest">Course Materials</h3>

                  <span className="text-[10px] text-slate-600 ml-1">Source materials for this lesson</span>
