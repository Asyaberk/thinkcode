...
def list_topics(
    ...
    """Return topics for a class. Returns all topics when no class_id given (instructor)."""
...
def update_topic(
    ...
    """Instructor: update topic name or description."""
...
def delete_topic(
    ...
    """Instructor: delete a topic and all its lessons and problems."""
