...
PATTERN_LABELS = {
    ...
    "socratic_retry":   "Socratic Retry (hint on wrong answer + retry)",

    "mastery_gate":     "Mastery Gate (consecutive correct answers required to advance)",

    "spaced_retrieval": "Spaced Retrieval (spaced repetition algorithm)",

    "adaptive_branch":  "Adaptive Branch (routes based on diagnostic performance)",
